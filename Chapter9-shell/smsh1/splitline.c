 ...
 * returns: dynamically allocated string holding commmand line
...
/**
 * splitline(parse a line into an array of string)
*/
#define is_delim(x) ((x) == ' ' || (x) == '\t')

/**
 * purpose: split a line into array of white-space separeted tokens
 * returns: a NULL-terminated array of points to copies of the tokens or NULL 
...
char **splitline(char *line) {
    ...
    while (*cp != '\0') {
        ...
        //make sure the arrayhas room( + 1 for NULL)
        if(argnum + 1 >= spots) {
