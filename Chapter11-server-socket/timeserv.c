 ...
 * compile - cc timeserv.c -o timeserv
 *           ./timeserv&
 * 
...
#define PORTNUM     13000   //our time service phone number - port
#define HOSTLEN     256
...
int main (int ac, char *av[]) {
    ...
    /*
    hp->h_addr  ==>  hp->h_addr_list
    */
    bcopy((void*)hp->h_addr, (void*)&saddr.sin_addr, hp->h_length);
    saddr.sin_port = htons(PORTNUM);           //fill in socket porrt
